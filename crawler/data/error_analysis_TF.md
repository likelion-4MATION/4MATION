...
| 혼입 문서 | 출현 | 소속 업무 |
|---|---|---|
| `kdic-fins-cm-bbs-selectFaqNramtAply` | 16 | 예금보험금 안내 |
| `kdic-www-sp-kmrs-kmrsItrdAplyTrgt-selectScrn` | 11 | 착오송금 반환 신청 |
| `kdic-fins-cm-bbs-selectFaqMsdrGvbkAply` | 9 | 착오송금 반환 신청 |
| `kdic-www-sp-dpstrprot-ProtSystFaq-selectScrn` | 8 | 예금자보호제도 |
| `kdic-fins-ir-aplygudn-MtrsGvbkSprtProc-selectScrn` | 8 | 착오송금 반환 신청 |
| `kdic-fins-ir-aplygudn-MsdrAddrsePossDcmntGudn-selectScrn` | 8 | 착오송금 반환 신청 |
| `kdic-www-sp-dpstrprot-DpsmIbamtExpln-selectScrn` | 7 | 예금보험금 안내 |
...
- dense rank: 9 · hybrid_bf rank: 10
- hybrid_bf top-3:
